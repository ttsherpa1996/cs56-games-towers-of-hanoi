...
public class HanoiTimer {
    ...
    private GregorianCalendar pt = new GregorianCalendar();
    ...
    public void resume() {
	pauseTime = pt.get(GregorianCalendar.SECOND) + 60*pt.get(GregorianCalendar.MINUTE) - startTime;
	stopped = false;
	paused = false;
    }
	...
	if(stopped || timeLabel == null)
	    return;
	else if(paused == true){
	    pt.setTimeInMillis(System.currentTimeMillis());	
	...
	//	    return;
	    ...
	    gc.setTimeInMillis(System.currentTimeMillis() - startTime - pauseTime);
